...
public class Main: SEScene
{
  ...
  public void initialize(SEResourceCache rsc) {
   ...
   // fg = add_sprite_for_color(Color.instance("#00c5cd"), get_scene_width()*0.1, get_scene_height()*0.1);
  
// fg.move(100,100);

	rsc.prepare_font("Daryl", "forte bold color=green", 40);
	disp = "Bounce = %d".printf().add(Primitive.for_integer(bounce)).to_string() ; 
	text = add_sprite_for_text(disp,"Daryl");
	text.move(0,get_scene_height()-text.get_height());
	 rsc.prepare_image("my_image","asd",get_scene_width()*0.2,get_scene_height()*0.2);
    ...
    speed+=50;
    rotation+=MathConstant.M_PI/4/2;      
